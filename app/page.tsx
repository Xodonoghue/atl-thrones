...
export default function Home() {
  const title2 = "text-3xl sm:text-4xl font-semibold"
  return (
    <main className="flex flex-col items-center bg-gradient-to-b from-black to-indigo-950 min-h-screen gap-10 sm:gap-15 py-10 sm:py-20">
      <div className="flex flex-col items-center gap-7.5 sm:gap-10 p-5">
        <h1 className="z-50 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-zinc-100 to-indigo-300 w-11/12 md:w-9/12">Make Any Special Occasion Even More Special</h1>
        <p className="flex w-10/12 md:w-8/12 text-center text-base sm:text-lg">We deliver throne chairs throughout the greater Atlanta area from Fayette all the way to Cherokee county click the button below to see if we have a chair available for your event.</p>
        ...
        <img src="https://otds17egwq.ufs.sh/f/zMShoxtoCQOcL7YIk2qmKNn89WqR6Z4sflaJib3IFoQjVBuY" width={700} className="rounded-md"></img>
      </div>
      ...
      <div className="flex flex-col items-center text-center gap-5 w-full p-5">
        ...
        <p className="w-10/12 text-lg sm:text-xl">We deliver throughout the following counties Fulton, Dekalb, Cobb, Gwinnett, Clayton, Fayette & Cherokee.</p>
      </div>
      <div className="flex flex-col text-center gap-5 p-10 bg-black rounded-lg border border-indigo-400 w-11/12 sm:w-3/4 md:w-7/12 lg:w-1/2">
