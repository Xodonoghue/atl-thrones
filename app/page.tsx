  ...
  return (
    <div className="container relative mx-auto p-2">
      ...
      <section className="text-center py-24 px-4">
        ...
        <h1 className="max-w-5xl text-6xl md:text-7xl lg:text-8xl font-medium text-center mt-6 max-w-2xl mx-auto">Make Any Celebration <br /> Even More Special
        </h1>
        <p className="text-gray-400 max-w-4xl text-xl mx-auto mt-4">
        ...
        <form className="flex justify-center gap-4 pt-8">
          <Link href="/availability" className="bg-gradient-to-r from-indigo-500 to-indigo-400 hover:from-indigo-400 hover:to-indigo-300 text-white border border-white/50 font-semibold text-2xl font-bold p-6 rounded-2xl hover:bg-indigo-300">
            Check Availablity
          </Link>
        </form>
      ...
      <section className="py-24 text-center px-4">
        ...
        <h2 className="text-6xl font-medium mt-8">About <span className="text-indigo-400">Us</span>
        </h2>
      ...
      <section className="py-24 text-center px-4">
        <div className="flex flex-col bg-black rounded-lg border bg-gray-950 border border-gray-700 max-w-7xl mx-auto p-8 items-center">
            <div className="flex flex-col md:flex-row w-full justify-between items-center">
                <div>
                <h3 className="text-4xl font-medium max-w-2xl text-center">Check to see if we have a chair available for your event</h3>
